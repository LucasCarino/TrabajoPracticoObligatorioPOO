...
public class ModificarPaciente extends JFrame {
    ...
    public ModificarPaciente() {
        ...
        btnModificarPaciente.setBackground(Color.BLUE);
        btnModificarPaciente.setOpaque(true);
        btnModificarPaciente.setFont(new Font("Arial", Font.BOLD, 14));
        btnModificarPaciente.setForeground(Color.WHITE);
        btnModificarPaciente.setPreferredSize(new Dimension(200, 20));

        buttonPanel.add(btnModificarPaciente, gbc);
